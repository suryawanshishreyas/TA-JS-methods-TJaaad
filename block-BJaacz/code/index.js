...
*/
// let numbers = [1,2,3,4];
function addThreeToArray(arr,addTwo){
  let final= [];
  for(let num of arr){
...
*/
// let numbers = [1,2,3,4];
function addFiveToArray(arr,addTwo){
  let final= [];
  for(let num of arr){
...
console.log(changeArray([1,2,3,4,5], addTwo));
console.log(changeArray([1,2,3,4,5], addThree));
console.log(changeArray([1,2,3,4,5], addFive));
