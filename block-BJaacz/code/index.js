...
function addTwoToArray(arr, cb){
  let finalArray = [];
  for(let num of arr){
    finalArray.push(num + cb);
  }
  
  return finalArray;
}
console.log(addTwoToArray(numbers, addThre));
/*
...
console.log(addTwoToArray(numbers, addFive));
/*
