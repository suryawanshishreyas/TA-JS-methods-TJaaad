...
*/
let character = quote.charAt(indexOfIs);
...
*/
let one = from.concat(' said ',quote);
let two = one.concat(' to ',to);
console.log(two);
/*
...
*/
console.log(quoteSplitted.toString().replace('today','tomorrow'));
...
*/
console.log(quote.slice(0,29).padEnd(33,'.'));
/*
21. Find out does quote, from, to starts with "A"
*/
console.log(quote.includes('A',0));
console.log(from.includes('A',0));
console.log(to.includes('A',0));